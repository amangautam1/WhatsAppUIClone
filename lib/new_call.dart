           ...
           itemBuilder: (context,l)=>new Column(
             children: <Widget>[
               ...
               new ListTile(
                 ...
                 title: new Text(cont[l].name,
                     style: new TextStyle(fontWeight: FontWeight.bold),),
                 subtitle: new Text("MOBILE",
                   style:new TextStyle(color:Theme.of(context).accentColor,fontSize:12.0),
                 ),
                 trailing:new Row(
                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
                 children: <Widget>[
                   new Icon(Icons.call,color: Theme.of(context).primaryColor,),
                   new Padding(
